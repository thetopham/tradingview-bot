...
def load_config():
    ...
    config['GET_FLAT_START'] = dtime(14, 5)  # 2:05 PM Mountain
    config['GET_FLAT_END'] = dtime(16, 0)    # 4:00 PM Mountain
    config['GET_FLAT_SUNDAY_REOPEN'] = dtime(16, 0)  # 4:00 PM Mountain Sunday reopen
